...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      setDashboardCache(campusId, responseData);
    } catch (error) {
  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-primary)' }} className="min-h-screen transition-colors duration-300">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 gap-3">
                  {data.topLocationStats.slice(0, 3).map((location, index) => {
                    const parts = location.totalDuration?.split(':') || ['00', '00'];
      ...
      <StudentModal isOpen={isModalOpen} student={selectedStudent} onClose={() => setIsModalOpen(false)} />
