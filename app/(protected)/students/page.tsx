...
export default function Students() {
  ...
  const fetchPools = async () => {
    try {
      const response = await fetch('/api/students/pools', {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-4 flex-wrap">
              <Link href="/dashboard" className="text-lg sm:text-xl font-bold text-(--text-primary) hover:text-(--primary) transition whitespace-nowrap">
                42 Watcher
              </Link>
              <nav className="flex items-center gap-6 text-sm sm:text-base">
                ...
                <Link href="/students" className="text-(--primary) border-b-2 border-(--primary) pb-1">Students</Link>
              </nav>
            </div>
              ...
              {students.map((student) => (
                ...
                >
                  <div className="flex gap-4 flex-col sm:flex-row">
                    <img
                      src={student.image.versions?.medium || student.image.link || "/placeholder.svg"}
                      alt={student.login}
